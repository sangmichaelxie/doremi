...
#
# Sample baseline model run of a 280M model with the same number of parameters as the 280M model in the DoReMi paper. Results may differ from DoReMi paper since the paper uses 256k vocab size and a different architecture. This short run is for 50k steps, compared to 200k in the paper.
#
