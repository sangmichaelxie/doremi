...
#
# Sample run of DoReMi 120M model with same number of non-embedding params as 280M model in DoReMi paper
#
...
accelerate launch \
    ...
    --reference_model_name_or_path ${MODEL_OUTPUT_DIR}/pile_baseline_120M/checkpoint-200000 \
    --fsdp full_shard \
    --bf16 \
