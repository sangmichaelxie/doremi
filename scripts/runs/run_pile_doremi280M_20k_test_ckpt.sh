...
PREPROCESSED_CACHE=${DOREMI_DIR}/preprocessed_sample_280m/
...
accelerate launch \
    ...
    --reference_model_name_or_path /export/project/shizhe/doremi_run/doremi/model_output_dir_0918/pile_baseline_280M_256kvocab/checkpoint-20000 \
    --bf16 \
