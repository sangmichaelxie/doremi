...
accelerate launch \
    ...
    --domain_config_path configs/rp_baseline.json \
    ...
    --config_overrides="max_position_embeddings=1024,hidden_size=768,num_hidden_layers=12,num_attention_heads=12,intermediate_size=3072,vocab_size=50432"
