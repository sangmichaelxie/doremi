...
accelerate launch \
    ...
    --config_overrides="max_position_embeddings=2048,hidden_size=1024,num_hidden_layers=18,num_attention_heads=16,intermediate_size=4096,vocab_size=50257"
